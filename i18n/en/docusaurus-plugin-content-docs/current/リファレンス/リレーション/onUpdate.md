...
description: "Referential actions on update (Cascade, SetNull, Restrict, NoAction)"
---
...
When using the GAS editor alone, specify `onUpdate` in the [relation definition](/docs/reference/relation/definition):
